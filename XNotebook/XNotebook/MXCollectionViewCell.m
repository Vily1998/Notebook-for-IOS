...
- (void)awakeFromNib {//界面启动以后立刻执行的方法
    [super awakeFromNib];
...
- (void)setTopic:(MXTopic*)topic {//给记事本参数赋值
...
- (void)startAnimation:(MXSelectCellAnimationType)type Compeletion:(void(^)())handler {//选择记事本的进入动画
    if (type == Rotate) {
