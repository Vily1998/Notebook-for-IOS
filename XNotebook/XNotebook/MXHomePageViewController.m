...
- (void)addTopic:(UIButton*)button {
    ...
    MXAlert *alert = [MXAlert alertWithTextField:@"添加记事本" message:@"" buttonTitles:@[@"取消", @"添加"] action:^(NSInteger index, NSString *text) {
    ...
    [alert addTextField:^(MXTextField *textField) {
        ...
        textField.placeholder = @"请输入记事本标题";
...
- (UIButton *)bottomButton {
    if (!_bottomButton) {
        ...
        [_bottomButton setTitle:@"添加记事本" forState:UIControlStateNormal];
